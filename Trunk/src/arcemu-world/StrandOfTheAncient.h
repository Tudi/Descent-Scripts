...
private:
	...
	tr1::array<GameObject *,2> m_boats;
	tr1::array<GameObject *,BUFF_COUNT> m_buffs;
	tr1::array<GameObject *,GATE_COUNT> m_gates;
	tr1::array<GameObject *,GATE_COUNT> m_gateSigils;
	tr1::array<GameObject *,GATE_COUNT> m_gateTransporters;
