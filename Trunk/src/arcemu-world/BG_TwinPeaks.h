...
class TwinPeaks : public CBattleground
{
	...
	uint32 m_lgroup;
public:
	TwinPeaks(MapMgr * mgr, uint32 id, uint32 lgroup, uint32 t);
	~TwinPeaks();
	...
	void PeriodicUpdateClientRemainingTime();

	static CBattleground * Create(MapMgr * m, uint32 i, uint32 l, uint32 t) { return new TwinPeaks(m, i, l, t); }
