...
extern SERVER_DECL SQLStorage<VehicleData, HashMapStorageContainer<VehicleData> >				VehicleDataStorage;
extern SERVER_DECL SQLStorage<SeatData, HashMapStorageContainer<SeatData> >						SeatDataStorage;
