...
enum INSTANCE_ABORT_ERROR
{
	...
	INSTANCE_ABORT_REQUIREMENT = 0x08,
    ...
    TRANSFER_ABORT_LOCKED_TO_DIFFERENT_INSTANCE     = 0x12,         // 420
    TRANSFER_ABORT_ALREADY_COMPLETED_ENCOUNTER      = 0x13          // 420
...
public:
	...
	void GetServerStats( float &AvgLatency, int &ActiveMapCount, int &ActiveCreatureCount, int &ActiveGamobjects, int &ActiveCorpses );
