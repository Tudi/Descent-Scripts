...
public:
	...
	PeonSleepingAI(Creature* pCreature) : CreatureAIScript(pCreature) 
	{
		...
		sEventMgr.AddEvent( target ,&Unit::EventCastSpell2 , target->GetGUID(), (uint32)18795, true, 0, 3000 + RandomUInt( 180000 ), 1, 1 );
	}
};
