...
/*
class KalecgosGossip : public GossipScript
{
public:
	void Destroy()
	{
...
void SetupMagistersTerrace(ScriptMgr* pScriptMgr) 
{
	...
	//Gossips
	/*GossipScript * KalecgosGossip = (GossipScript*) new KalecgosGossip();
	mgr->register_gossip_script(GOSSIP_KALECGOS, KalecgosGossip);*/
}