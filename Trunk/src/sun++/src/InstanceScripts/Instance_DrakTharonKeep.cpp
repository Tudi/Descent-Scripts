...
class TrollgoreAI : public MoonScriptBossAI
{
	...
	{
		AddSpell(Consume, Target_Self, 75, 0, 37, 0, 50);
		AddSpell(CorpseExplode, Target_ClosestCorpse, 59, 0, 57);
		AddSpell(Crush, Target_Current, 90, 0, 20);
		AddSpell(InfectedWound, Target_Current, 95, 0, 11);
	}
};
...
// TODO:  
// - Phase Two
class TheProphetTharonjaAI : public MoonScriptBossAI
{
    MOONSCRIPT_FACTORY_FUNCTION(TheProphetTharonjaAI, MoonScriptBossAI);
	TheProphetTharonjaAI(Creature* pCreature) : MoonScriptBossAI(pCreature)
	{
