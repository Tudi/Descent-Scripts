...
public:
    ...
    void OnTargetDied(Unit* mTarget)
    {
        if(_unit->GetHealthPct() > 0)
        {
            ...
            _unit->CastSpellAoF(mTarget,mTarget->GetPositionX(),mTarget->GetPositionY(),mTarget->GetPositionZ(), spells[5].info, spells[5].instant);
...
public:
    ...
    void AIUpdate()
    {
        ...
        {
            // Summon 6 druids
            _unit->CastSpellAoF(_unit,_unit->GetAIInterface()->GetNextTarget()->GetPositionX(),_unit->GetAIInterface()->GetNextTarget()->GetPositionY(),_unit->GetAIInterface()->GetNextTarget()->GetPositionZ(), spells[4].info, spells[4].instant);
            _unit->CastSpellAoF(_unit,_unit->GetAIInterface()->GetNextTarget()->GetPositionX(),_unit->GetAIInterface()->GetNextTarget()->GetPositionY(),_unit->GetAIInterface()->GetNextTarget()->GetPositionZ(), spells[4].info, spells[4].instant);
            _unit->CastSpellAoF(_unit,_unit->GetAIInterface()->GetNextTarget()->GetPositionX(),_unit->GetAIInterface()->GetNextTarget()->GetPositionY(),_unit->GetAIInterface()->GetNextTarget()->GetPositionZ(), spells[4].info, spells[4].instant);
            _unit->CastSpellAoF(_unit,_unit->GetAIInterface()->GetNextTarget()->GetPositionX(),_unit->GetAIInterface()->GetNextTarget()->GetPositionY(),_unit->GetAIInterface()->GetNextTarget()->GetPositionZ(), spells[4].info, spells[4].instant);
            _unit->CastSpellAoF(_unit,_unit->GetAIInterface()->GetNextTarget()->GetPositionX(),_unit->GetAIInterface()->GetNextTarget()->GetPositionY(),_unit->GetAIInterface()->GetNextTarget()->GetPositionZ(), spells[4].info, spells[4].instant);
...
public:
    ...
    void AIUpdate()
    {
        ...
        if ((_unit->GetHealthPct() == 25 && Shade3 == false) || (_unit->GetHealthPct() == 50 && Shade2 == false) || (_unit->GetHealthPct() == 75 && Shade1 == false))
        {
            ...
            {        
                _unit->CastSpellAoF((*itr),(*itr)->GetPositionX(),(*itr)->GetPositionY(),(*itr)->GetPositionZ(), spells[4].info, spells[4].instant);
            }
            _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, spells[4].speech.c_str());
        }
