...
//get spells
$get_query = "select col_35,col_36,col_37,col_38,col_39,col_40,col_41,col_42 from itemsetdbccsv ";
...
$get_query = "select id from dbc_spell where id in ($sql_list) and (EffectApplyAuraName_1=4 or EffectApplyAuraName_2=4 or EffectApplyAuraName_3=4 or EffectApplyAuraName_1=42 or EffectApplyAuraName_2=42 or EffectApplyAuraName_3=42) and id>50000";
