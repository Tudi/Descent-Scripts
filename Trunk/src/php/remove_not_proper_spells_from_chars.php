...
$remove_spells_from_char_class[5] = array();
$remove_spells_from_char_class[6] = array(55050,50029,50034,93099,49143,50887,54637,55090,52143,91107,56835);
...
$get_query3 = "SELECT guid,class,spells,name FROM characters order by guid asc"; 
