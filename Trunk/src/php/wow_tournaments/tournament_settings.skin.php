...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <form name="<?=$table_name?>_form" action="index.php?skin=<?=$file_name?>&id=<?=$id?>" method="post">
    ...
    <tr>
      ...
      <td class="clsFormText01"><input class="clsTextField01" type="text" name="tournament_settings_inscription_starts" value="<?=$tournament_settings_inscription_starts?>"><?php echo date("Y-M-d h:m",$tournament_settings_inscription_starts); ?>
    ...
    <tr>
      ...
      <td class="clsFormText01"><input class="clsTextField01" type="text" name="tournament_settings_inscription_ends" value="<?=$tournament_settings_inscription_ends?>"><?php echo date("Y-M-d h:m",$tournament_settings_inscription_ends); ?>
    ...
    <tr>
      ...
      <td class="clsFormText01"><input class="clsTextField01" type="text" name="tournament_settings_tournament_starts" value="<?=$tournament_settings_tournament_starts?>"><?php echo date("Y-M-d h:m",$tournament_settings_tournament_starts); ?>
