...
while($list_row=mysql_fetch_array($result, MYSQL_ASSOC))
{
	...
	$list_sql="select is_pending_to_join_team,is_pending_to_accept_team_invite from tournament_players where team_id='$tournament_team_list_team_id' and player_guid='$s_user_guid' ";
	$result1=mysql_query($list_sql,$dbi) or die("200901261641");
	...
	if( $is_pending_to_join_team == 0 && $is_pending_to_accept_team_invite == 0 )
		continue;
	if( $is_pending_to_join_team == "" )
