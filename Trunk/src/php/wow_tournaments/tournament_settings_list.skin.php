...
while($list_row=mysql_fetch_array($result, MYSQL_ASSOC))
{
	...
	$tournament_settings_list_inscription_starts = date("Y-M-d h:m",$tournament_settings_list_inscription_starts);
	$tournament_settings_list_inscription_ends = date("Y-M-d h:m",$tournament_settings_list_inscription_ends);
	$tournament_settings_list_tournament_starts = date("Y-M-d h:m",$tournament_settings_list_tournament_starts);
