...
//	{"EffectDicePerLevel", 3, offsetof(SpellEntry, EffectDicePerLevel[0])},
	...
	{"EffectMultipleValue", 3, offsetof(SpellEntry, EffectConversionCoef[0])},
	...
	{"EffectSpellClassMask", 0, offsetof(SpellEntry, EffectSpellGroupRelation[0][0])},
	...
	{"SpellFamilyName", 0, offsetof(SpellEntry, SpellGroupName)},
...
//	{"EffectSpellGroupRelation_high", 0, offsetof(SpellEntry, EffectSpellGroupRelation[0])},
...
namespace LuaSpell
{
	...
	{
		if (!sp) return 0;
		lua_pushboolean(L, sp->GetProto()->BGR_one_buff_on_target & SPELL_TYPE_ASPECT);
		return 1;
	}
	...
	{
		if (!sp) return 0;
		lua_pushboolean(L, sp->GetProto()->BGR_one_buff_on_target & SPELL_TYPE_SEAL);
		return 1;
	}
