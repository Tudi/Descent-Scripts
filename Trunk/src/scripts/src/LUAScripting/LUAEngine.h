...
std::vector<uint16> EventAsToFuncName[SERVER_HOOK_COUNT]; //an array of string based vectors.
...
private:
	...
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> UnitBindingMap;
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> QuestBindingMap;
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> GameObjectBindingMap;
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> GossipUnitScriptsBindingMap;
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> GossipItemScriptsBindingMap;
	typedef HM_NAMESPACE::hash_map<uint32, LuaObjectBinding> GossipGOScriptsBindingMap;
