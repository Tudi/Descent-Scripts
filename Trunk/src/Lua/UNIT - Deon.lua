function decon_Combat(pUnit, Event)
	pUnit:PlaySoundToSet(15724)
	pUnit:SendChatMessage(14, 0, "New toys? For me? I promise I won't break them this time!")
	pUnit:RegisterEvent("decon_OnCombat", 6000, 1)
end

function decon_OnCombat(pUnit, Event)
	if pUnit:GetHealthPct() <= 75 then
		pUnit:RegisterEvent("decon_Phase2", 1000, 0)
	else
...
function decon_OnCombat2(pUnit, Event)
	if pUnit:GetHealthPct() <= 50 then
		pUnit:RegisterEvent("decon_Phase2a", 1000, 0)
	else
		pUnit:RegisterEvent("decon_GBomb", 25000, 0)
		pUnit:RegisterEvent("decon_SLight", 35000, 0)
		pUnit:RegisterEvent("decon_Buffchk", 60000, 0)
...
RegisterUnitEvent(33293, 1, "decon_Combat")
...
function decon_Phase2(pUnit, Event)
	...
	z = pUnit:GetZ()
	o = pUnit:GetO()
	pUnit:SpawnCreature(33995, x, y+5, z+15, o, 22, 0)
...
function deconhrt_Spawn(pUnit, Event)
	...
	z = deconhrt:GetZ()
	o = deconhrt:GetO()
	pUnit:SpawnCreature(33344, x, y+10, z, o, 22, 0)
	pUnit:SpawnCreature(33344, x+10, y, z, o, 22, 0)
	pUnit:SpawnCreature(33344, x, y-10, z, o, 22, 0)
	pUnit:SpawnCreature(33343, x+10, y, z, o, 22, 0)
	pUnit:SpawnCreature(33343, x, y+10, z, o, 22, 0)
	pUnit:SpawnCreature(33343, x+10, y, z, o, 22, 0)
	pUnit:SpawnCreature(33346, x, y+5, z, o, 22, 0)
	pUnit:SpawnCreature(33346, x+5, y, z, o, 22, 0)
	pUnit:SpawnCreature(33346, x, y-5, z, o, 22, 0)
end
...
RegisterUnitEvent(33344, 1, "pumeller_OnCombat")
...
RegisterUnitEvent(33343, 1, "scrapbot_OnCombat")
...
RegisterUnitEvent(33346, 1, "boombot_OnCombat")
